...
{
    [TestFixture]
    public class NewContactCreations
    {
        ...
        private void ReturnToTheContactPage()
        {
            driver.FindElement(By.LinkText("home page")).Click();
        }

        private void SubmitContactCreations()
        {
            driver.FindElement(By.XPath("//input[21]")).Click();
        }

        private void FillContactForm(ContactForm contact)
        {
